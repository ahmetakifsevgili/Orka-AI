...
Rule dosyaları `.Codex/rules/` altındadır, YAML frontmatter ile **path-scoped** yüklenirler — doğru rule, doğru zamanda gelir.
...
Kişisel not/tercihlerin varsa `Codex.local.md` dosyasına yaz — otomatik okunur ve gitignore'dur, commit'lenmez.
