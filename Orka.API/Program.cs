...
builder.Services.AddScoped<IAssessmentBlueprintService, AssessmentBlueprintService>();
...
builder.Services.AddScoped<IActiveLessonSnapshotService, ActiveLessonSnapshotService>();
builder.Services.AddScoped<IUnifiedToolRuntimeService, UnifiedToolRuntimeService>();
builder.Services.AddScoped<ILearningRuntimeTelemetryService, LearningRuntimeTelemetryService>();
builder.Services.AddScoped<IAgenticTrustPolicyService, AgenticTrustPolicyService>();
builder.Services.AddScoped<IKorteksSynthesisService, KorteksSynthesisService>();
builder.Services.AddScoped<IAdaptiveStudyPlannerService, AdaptiveStudyPlannerService>();
builder.Services.AddScoped<IPlanSequencingService, PlanSequencingService>();
...
builder.Services.AddScoped<IContentOperationsService, ContentOperationsService>();
builder.Services.AddScoped<ICurriculumSourceRegistryService, CurriculumSourceRegistryService>();
...
builder.Services.AddScoped<IQuestionQualityAnalyticsService, QuestionQualityAnalyticsService>();
...
builder.Services.AddScoped<ITutorResponsePolicyService, TutorResponsePolicyService>();
...
builder.Services.AddScoped<ILearningArtifactService, LearningArtifactService>();
builder.Services.AddScoped<ILearningNotebookStudioService, LearningNotebookStudioService>();
...
builder.Services.AddScoped<ISourceEvidenceLifecycleService, SourceEvidenceLifecycleService>();
...
builder.Services.AddScoped<ISourceConceptLinkingService, SourceConceptLinkingService>();
builder.Services.AddScoped<ISourceQuestionService, SourceQuestionService>();
builder.Services.AddScoped<ISourceCompareService, SourceCompareService>();
builder.Services.AddScoped<ISourceQuestionThreadService, SourceQuestionThreadService>();
