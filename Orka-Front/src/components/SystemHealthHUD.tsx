      ...
      <div className="h-full overflow-y-auto">
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-5 py-8 lg:px-8 lg:py-10">
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
            ...
            <MetricCard icon={Cpu} label="Ajan online" value={`${onlineAgents}/${data.agents.length}`} hint="Yeni Quiz, Diagnostic, Remedial, Visual ve audio overview rolleri dahil." tone="emerald" />
                    ...
                    <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
                      <div>
                        ...
                        <p className="mt-1 text-xs text-[#667085]">
                          Quiz, Wiki/Notebook, Audio Overview, IDE ve telafi sinyalleri aynı öğrenme hafızasına bağlanıyor mu?
                        </p>
                      </div>
