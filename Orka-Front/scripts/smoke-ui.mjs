...
addCheck("OrkaLM source-to-concept graph UI visible", wiki.includes("Source-to-concept graph") && wiki.includes("sourceConceptLinks") && wiki.includes("sourceConceptGraph") && wiki.includes("handleSyncSourceConceptLinks") && wiki.includes("Oneri grafigi"));
...
addCheck("Notebook Studio panel is wired into Wiki", wiki.includes("NotebookStudioPanel") && notebookStudio.includes("Milestone Pack") && notebookStudio.includes("mind_map") && notebookStudio.includes("uml_diagram") && notebookStudio.includes("review_quiz"));
addCheck("Notebook Studio production states are visible", notebookStudio.includes("Kaynak hazirlik") && notebookStudio.includes("Notebook Studio paketleri yuklenemedi") && notebookStudio.includes("audio_script") && notebookStudio.includes("Henuz cikti yok."));
addCheck("Notebook Studio phase 2-4 professional preview is visible", notebookStudio.includes("ProfessionalArtifactPreview") && notebookStudio.includes("PropertiesMatrix") && notebookStudio.includes("GraphContractPreview") && notebookStudio.includes("TemplateSetPreview") && notebookStudio.includes("SearchFilterPreview") && notebookStudio.includes("SlideDeckPreview") && notebookStudio.includes("PhaseSevenAudioNotice"));
...
addCheck("Notebook Studio audio actions are phase 7 active", notebookStudio.includes('  "audio_overview",') && notebookStudio.includes('  "audio_script",') && notebookStudio.includes('  "audio_transcript",') && notebookStudio.includes('  "caption_track",') && notebookStudio.includes('  "narration_script",') && notebookStudio.includes("Sesli ders paketi aktif") && notebookStudio.includes("phase 7 audio active"));
addCheck("Notebook Studio media copy avoids fake export claims", notebookStudio.includes("Slide export manifest") && !notebookStudio.includes("PPTX indir") && !notebookStudio.includes("Video hazir"));
...
addCheck("Notebook Studio export preview is useful", notebookStudio.includes("Slayt listesi") && notebookStudio.includes("Kaynak temeli") && notebookStudio.includes("Erisilebilirlik") && notebookStudio.includes("Export scope") && notebookStudio.includes("Checkpoint var") && notebookStudio.includes("Speaker notes var"));
...
addCheck("Notebook Studio UI copy is readable", !notebookMojibake.test(notebookStudio) && notebookStudio.includes("Calisma rehberi") && notebookStudio.includes("Zayif alan") && notebookStudio.includes("UML / Mermaid"));
...
addCheck("Central exams product shell is visible", (sidebar.includes("Merkezi Sınavlar") || sidebar.includes("exams")) && (centralHome.includes("central-exams") || centralHome.includes("exams")) && centralExams.includes("Merkezi Sinavlar") && centralExams.includes("KPSS hazirlik iskeleti"));
...
addCheck("OrkaLM source notebook is wired into app shell", (home.includes('"sources"') || home.includes('"sources-wiki"')) && home.includes('mode="orkalm"') && (sidebar.includes('labelKey: "sources"') || sidebar.includes('labelKey: "sources_wiki"')) && messages.includes("sources"));
