...
addCheck("Tutor chat stays focused instead of carrying workspace rails", !chatPanel.includes("ToolCapabilityStrip") && !chatPanel.includes("AgentStatusRail") && !chatPanel.includes("ArtifactCanvas") && chatPanel.includes("composer-action-menu-trigger") && agenticWorkspace.includes("workspaceState?.currentPlanStep") && agenticWorkspace.includes("workspaceState?.sourceReadiness"));
