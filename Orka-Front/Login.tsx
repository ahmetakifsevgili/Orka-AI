          ...
          <div className="max-w-md">
            ...
            >
              ...
              <p className="text-sm text-zinc-500 leading-relaxed max-w-sm">
                Yapay zeka destekli kişiselleştirilmiş müfredat, interaktif
                quizler ve canlı wiki ile her konuda uzmanlaşın.
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  desc: "AI sizin için özel öğrenme yolları oluşturur",
                },
                {
                  title: "Adaptif Quizler",
                  desc: "Seviyenize göre ayarlanan soru bankası",
                },
                {
                  title: "Canlı Wiki",
                  desc: "Öğrendikleriniz otomatik olarak belgelenir",
                },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 py-3 bg-zinc-100 text-zinc-950 rounded-lg text-sm font-medium hover:bg-zinc-200 transition-colors duration-150 disabled:opacity-50"
            >
              {isLoading ? (
          ...
          <div className="space-y-2.5">
            <button
              ...
              className="w-full flex items-center justify-center gap-2.5 py-3 bg-zinc-900 border border-zinc-800 rounded-lg text-sm text-zinc-300 hover:bg-zinc-800/80 hover:border-zinc-700 transition-colors duration-150"
            >
